...
# create a list from the weight tuning data frame
criteria_weights_list <- split(criteria_weights, seq(nrow(criteria_weights)))
...
```{r}
saveRDS(criteria_weights_list, "data/criteria_weights_list.RDS")
```
