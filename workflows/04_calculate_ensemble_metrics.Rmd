...
## TODO: Use nested lapply() here so compute the warming results for the 3 time periods. For each element in `rel_model_results` use `metric_calc()` across a list of metric elements (shirt-term - 2021-2040, mid-term - 2041-2060, long-term - 2081-2100)
